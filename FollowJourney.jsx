        ...
        <section className="follow-journey-section">
            <div className="container grid-split-30-70">
                <div className="journey-left">
                    ...
                    <a href="https://www.instagram.com/backpackers.destinations/" target="_blank" rel="noreferrer" className="btn-primary" style={{ display: 'inline-block', textDecoration: 'none' }}>
